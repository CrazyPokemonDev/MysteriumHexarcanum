...
cloche {
    metadata {
        modId = "mysterium_hexarcanum"
        name = "Mysterium Hexarcanum"
        description = "Mysterium Hexarcanum addon for Hex Casting"
        license = "MIT"

        author("Olfi01")
        url = "https://crazypokemondev.github.io/MysteriumHexarcanum"
        sources = "https://github.com/CrazyPokemonDev/MysteriumHexarcanum"
        issues = "https://github.com/CrazyPokemonDev/MysteriumHexarcanum/issues"
    }

    common {
        accessWideners.from(file("src/common/mysterium_hexarcanum.accesswidener"))
        mixins.from(file("src/common/mysterium_hexarcanum.mixins.json"))
    ...
    fabric("fabric:1.21.1") {
        ...
        mixins.from(file("src/fabric/1.21.1/mysterium_hexarcanum-fabric.mixins.json"))
        includedClient()
        data()
        ...
        metadata {
            entrypoint("main") {
                value = "de.crazypokemondev.mysterium_hexarcanum.FabricMysteriumHexarcanum"
                adapter = "kotlin"
            }
            entrypoint("client") {
                value = "de.crazypokemondev.mysterium_hexarcanum.client.FabricMysteriumHexarcanumClient"
                adapter = "kotlin"
            }
            entrypoint("fabric-datagen") {
                value = "de.crazypokemondev.mysterium_hexarcanum.datagen.FabricMysteriumHexarcanumDatagen"
                adapter = "kotlin"
            }
            dependencies {
                dependency {
    ...
    neoforge("neoforge:1.21.1") {
        ...
        mixins.from(file("src/neoforge/1.21.1/mysterium_hexarcanum-neoforge.mixins.json"))
        data()
...
yamlang {
    ...
    inputDir = "assets/mysterium_hexarcanum/lang"
