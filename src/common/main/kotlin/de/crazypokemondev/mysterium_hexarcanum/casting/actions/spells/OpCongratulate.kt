package de.crazypokemondev.mysterium_hexarcanum.casting.actions.spells
...
object OpCongratulate : SpellAction {
    ...
    private data class Spell(val target: Entity) : RenderedSpell {
        ...
        override fun cast(env: CastingEnvironment) {
            env.printMessage("text.mysterium_hexarcanum.congrats".asTranslatedComponent(target.displayName!!))
        }
    }
}
